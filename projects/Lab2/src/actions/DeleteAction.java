...
public class DeleteAction implements ActionListener
{
	...
	public DeleteAction(View view, InteractionComp comp)
	{
		this.view = view;
		this.comp = comp;
	}
	...
	public void actionPerformed(ActionEvent event)
	{
		...
		switch(mod)
		{
			case 0:
			{
				...
				{
					controller.Delete(0, field1.getText(), field2.getText());
					view.refreshDeleteFrame();
				}
			} break;
			case 1:
			{
				...
				{
					controller.Delete(1, field1.getText(), field2.getText());
					view.refreshDeleteFrame();
				}
			} break;
			case 2:
			{
				...
				{
					controller.Delete(2, field1.getText(), field2.getText());
					view.refreshDeleteFrame();
				}
			} break;
		}
